...
export default function CodebaseOverviewPage() {
    ...
    return (
        <div className="p-6 md:p-8 space-y-8 max-w-7xl mx-auto pb-20">
            ...
            {/* Global Tabs - Sticky Header */}
            {analysis && !loading && (
                <div className="sticky top-0 z-10 bg-background/95 backdrop-blur pt-2 border-b mb-6 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                ...
                <div className="lg:col-span-3 space-y-6 min-w-0">
                    {!analysis && !loading && (
                        <div className="h-[400px] flex flex-col items-center justify-center p-8 border-2 border-dashed rounded-xl bg-muted/30">
                            <div className="w-16 h-16 rounded-full bg-muted flex items-center justify-center mb-4">
                                <Code2 className="w-8 h-8 text-muted-foreground" />
                            </div>
                            <h3 className="text-xl font-semibold mb-2">No Analysis Loaded</h3>
                            <p className="text-muted-foreground text-center max-w-sm">
                                Select a repository from the sidebar to begin analyzing your codebase structure and details.
                            </p>
                        </div>
                    )}
                ...
                <div className="lg:col-span-1 space-y-6">
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            {error && !analysis && (
                                <div className="p-3 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 rounded-lg text-xs text-red-700 dark:text-red-300">
                                    {error}
                                </div>
                            )}
                            <div className="space-y-2">
                                <label className="text-sm font-medium">Select Codebase</label>
                                <NativeSelect
                                    value={selectedRepo}
                                    onChange={(e) => {
